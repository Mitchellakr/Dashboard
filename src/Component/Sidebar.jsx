...
//                 </h1>
//             </div>
//             <div className="menu h-full flex flex-col gap-[10em]">
//                 <div>
//                     {
//                         navlinks.map((navlink) => (
//                             <Link to={navlink.path} key={navlink.id} className='mb-4 text-grayColor cursor-pointer flex items-center gap-4 hover:border-4 hover:border-solid hover:border-primaryColor hover:border-y-0 hover:border-r-0 hover:text-primaryColor font-bold pl-[3em] py-3'>
//                                 {navlink.icon}
//                                 <p>{navlink.navname}</p>
//                             </Link>
//                         ))
//                     }
//                     <div className='text-redColor cursor-pointer flex items-center gap-4 hover:border-4 hover:border-solid hover:border-redColor hover:border-y-0 hover:border-r-0 font-bold pl-[3em] py-3 mt-10'>
//                         <LogoutCurve size='20' />
...
const Sidebar = () => {
    return (
        <div className='bgdark w-[270px]  bg-bodyColor border-r-2 border-solid border-grayColorLight border-y-0 border-l-0'>
            <div className='w-full py-14'>
                <h1 className='textwhite text-2xl font-semibold flex flex-col items-center'>
                    <span>Ticcki</span><span>Cassa</span>
                </h1>
